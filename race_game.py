    ...
    while not gameExit:
        ...
        if y < thing_starty + thing_height:  # player crossed virus w.r.t to Y-axis
            ...
            if (
                ...
                and player_safe == False
                or x + player_width > thing_startx
                and x + player_width < thing_startx + thing_width
                and player_safe == False
            ):
                # print('x crossover')
                crash()
        ...
        if y < police_starty + police_height:  # player crossed police w.r.t Y-axis
            ...
            if (
                x > police_startx
                and x < police_startx + police_width
                and police_status
                or x + player_width > police_startx
                and x + player_width < police_startx + police_width
                and police_status
            ):
        ...
        if y < health_starty + health_height:  # player crossed health w.r.t Y-axis
            ...
            if (
                x > health_startx
                and x < health_startx + health_width
                and health_status
                or x + player_width > health_startx
                and x + player_width < health_startx + health_width
                and health_status
            ):
